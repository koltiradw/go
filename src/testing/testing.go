...
func (f matchStringOnly) CoordinateFuzzing(time.Duration, int64, time.Duration, int64, time.Duration, int, []corpusEntry, []reflect.Type, string, string) error {
	return errMain
}
...
type testDeps interface {
	...
	CoordinateFuzzing(time.Duration, int64, time.Duration, int64, time.Duration, int, []corpusEntry, []reflect.Type, string, string) error
